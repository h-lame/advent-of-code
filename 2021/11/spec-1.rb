...
RSpec.describe Solution do
  ...
  it 'gives the correct solution for the example' do
    ...
    expect(octopus_simulator.simulate(steps: 3)).to eq(
      [
        [0, 0, 5, 0, 9, 0, 0, 8, 6, 6],
        [8, 5, 0, 0, 8, 0, 0, 5, 7, 5],
        [9, 9, 0, 0, 0, 0, 0, 0, 3, 9],
    ...
    expect(octopus_simulator.simulate(steps: 4)).to eq(
      [
        [2, 2, 6, 3, 0, 3, 1, 9, 7, 7],
        [0, 9, 2, 3, 0, 3, 1, 6, 9, 7],
        [0, 0, 3, 2, 2, 2, 1, 1, 5, 0],
    ...
    expect(octopus_simulator.simulate(steps: 5)).to eq(
      [
        [4, 4, 8, 4, 1, 4, 4, 0, 0, 0],
        [2, 0, 4, 4, 1, 4, 4, 0, 0, 0],
        [2, 2, 5, 3, 3, 3, 3, 4, 9, 3],
    ...
    expect(octopus_simulator.simulate(steps: 6)).to eq(
      [
        [5, 5, 9, 5, 2, 5, 5, 1, 1, 1],
        [3, 1, 5, 5, 2, 5, 5, 2, 2, 2],
        [3, 3, 6, 4, 4, 4, 4, 6, 0, 5],
    ...
    expect(octopus_simulator.simulate(steps: 7)).to eq(
      [
        [6, 7, 0, 7, 3, 6, 6, 2, 2, 2],
        [4, 3, 7, 7, 3, 6, 6, 3, 3, 3],
        [4, 4, 7, 5, 5, 5, 5, 8, 2, 7],
    ...
    expect(octopus_simulator.simulate(steps: 8)).to eq(
      [
        [7, 8, 1, 8, 4, 7, 7, 3, 3, 3],
        [5, 4, 8, 8, 4, 7, 7, 4, 4, 4],
        [5, 6, 9, 7, 6, 6, 6, 9, 4, 9],
    ...
    expect(octopus_simulator.simulate(steps: 9)).to eq(
      [
        [9, 0, 6, 0, 0, 0, 0, 6, 4, 4],
        [7, 8, 0, 0, 0, 0, 0, 9, 7, 6],
        [6, 9, 0, 0, 0, 0, 0, 0, 8, 0],
    ...
    expect(octopus_simulator.simulate(steps: 10)).to eq(
      [
        [0, 4, 8, 1, 1, 1, 2, 9, 7, 6],
        [0, 0, 3, 1, 1, 1, 2, 0, 0, 9],
        [0, 0, 4, 1, 1, 1, 2, 5, 0, 4],
    ...
    expect(octopus_simulator.result).to eq 1656
  end
end
