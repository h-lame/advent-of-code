...
RSpec.describe Solution2 do
  ...
  describe described_class::Hand do
    ...
    it 'sorts based on type value of cards for same type' do
      ...
      expect(hands.sort.map(&:cards)).to eq ['AAAAA', 'KKKKK', 'QQQQQ', 'TTTTT', '99999', '88888', '77777', '66666', '55555', '44444', '33333', '22222', 'JJJJJ']
  ...
  it 'ranks the hands correctly considering jokers' do
    expect(
  ...
  it 'gives the correct solution for the example' do
    expect(described_class.new(raw_hands).result).to eq 5905
  end
end
